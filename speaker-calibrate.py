...
def vendor_trial_active():
    try:
        ...
        return False
    return bool(marker) and graph_kind() == "vendor-trial"
...
def vendor_try(reference=None):
    """Stop the calibration and let Omarchy's installer play the rendered tuning."""
...
def vendor_restore():
    """Take Omarchy's tuning off again and play the calibration."""
...
def main():
    ...
    if command == "devices-json":
        ...
        print(json.dumps(vendor_try(reference=args.reference)))
